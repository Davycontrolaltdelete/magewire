...
test('test', async ({ page }) => {
    await page.goto('https://magewire-magento.test/magewire/examples');



    await page.getByPlaceholder('Task Description...').click();
    await page.getByPlaceholder('Task Description...').fill('First tastk');
    ...
    await expect(page.getByText('First tastk')).toBeVisible();
